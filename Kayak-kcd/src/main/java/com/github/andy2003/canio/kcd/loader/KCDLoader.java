...
package com.github.andy2003.canio.kcd.loader;

import com.github.andy2003.canio.kcd.BasicLabelType;
import com.github.andy2003.canio.kcd.Bus;
import com.github.andy2003.canio.kcd.Consumer;
import com.github.andy2003.canio.kcd.Label;
import com.github.andy2003.canio.kcd.LabelGroup;
import com.github.andy2003.canio.kcd.LabelSet;
import com.github.andy2003.canio.kcd.Message;
import com.github.andy2003.canio.kcd.Multiplex;
import com.github.andy2003.canio.kcd.MuxGroup;
import com.github.andy2003.canio.kcd.NetworkDefinition;
import com.github.andy2003.canio.kcd.Node;
import com.github.andy2003.canio.kcd.NodeRef;
import com.github.andy2003.canio.kcd.Producer;
import com.github.andy2003.canio.kcd.Signal;
import com.github.andy2003.canio.kcd.Value;
...
import com.github.andy2003.core.description.MessageDescription;
import com.github.andy2003.core.description.MultiplexDescription;
import com.github.andy2003.core.description.SignalDescription;
import java.io.File;
...
public class KCDLoader implements DescriptionLoader {
    ...
    public KCDLoader() {
        ...
        try {
            context = JAXBContext.newInstance(new Class[]{com.github.andy2003.canio.kcd.NetworkDefinition.class});
    ...
    public Document parseFile(File file) {
        ...
        com.github.andy2003.canio.kcd.Document documentInfo = netdef.getDocument();
        ...
        for(Node n : netdef.getNode()) {
            com.github.andy2003.core.description.Node node = doc.createNode(n.getId(), n.getName());
        }
            ...
            for(Message m :  b.getMessage()) {
                ...
                if(producer != null) {
                    ...
                    if(ref.size() > 1) {
                        ...
                        com.github.andy2003.core.description.Node n = doc.getNodeWithID(id);
                        if(n != null)
                    ...
                    for(MuxGroup group : multiplex.getMuxGroup()) {
                        ...
                        for(Signal s : group.getSignal()) {
                            ...
                            if(c != null && c.getNodeRef() != null) {
                                ...
                                HashSet<com.github.andy2003.core.description.Node> consumers = new HashSet<com.github.andy2003.core.description.Node>();

                                for(NodeRef nr : signalRef) {
                                    com.github.andy2003.core.description.Node n = doc.getNodeWithID(nr.getId());
                                    if(n != null)
                                        consumers.add(n);
                                }
                            }
    ...
    private com.github.andy2003.core.description.SignalDescription signalToSignalDescription(Signal s, SignalDescription signalDescription) {
            ...
            if(labels != null) {
                for(BasicLabelType basicLabel : labels) {
                    if(basicLabel instanceof Label) {
                        ...
                        com.github.andy2003.core.description.Label label = new com.github.andy2003.core.description.Label(l.getValue().longValue(), l.getName());
                        signalDescription.addLabel(label);
                    } else if(basicLabel instanceof LabelGroup) {
                        LabelGroup l = (LabelGroup) basicLabel;
                        com.github.andy2003.core.description.Label label = new com.github.andy2003.core.description.Label(l.getFrom().longValue(), l.getTo().longValue(), l.getName());
                        signalDescription.addLabel(label);
                    }
                }
            }
